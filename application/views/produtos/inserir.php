<div class="container">
    <div class="col-md-12">
        ...
        echo form_open_multipart('produtos/salvar', array('id' => 'validation'));
        ?>
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <select name="id_categoria" class="form-control" required>
                    ...
                    <?php foreach ($listaCategorias as $i){ ?>
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <label>Imagem</label>
                <input type="file" name="fileimg02" size="20"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mb-3">
                <label>Imagem</label>
                <input type="file" name="fileimg03" size="20"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mb-3">
