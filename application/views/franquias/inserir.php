...
<h3>Inserir Franquia</h3>
        ...
        echo form_open_multipart('franquias/salvar', array('id' => 'validation'));
        ?>
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" name="sub-titulo" value="" class="form-control" placeholder="Sub Titulo">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mb-3">
