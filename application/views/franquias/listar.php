...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            <a href="<?php echo base_url('franquias/inserir'); ?>" class="btn btn-success margin-button15"><i class="fas fa-plus-circle"></i> Novo</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table-sm table-bordered">
                    ...
                    foreach ($lista as $it) : ?>
                        <tr>
                            ...
                            <td align="center"><img src="<?php echo base_url('upload/img/franquias/'. $it->img_1) ?>" class="img-thumbnail"></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-primary" <?php echo 'href="' . base_url('franquias/remover/' . $it->id) . '"' ?> >Sim</a>
