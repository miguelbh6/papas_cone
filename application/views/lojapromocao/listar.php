<div class="container"> 
    ...
    <?php if (sizeof($lista) < 3){ ?>
        <div class="row">
            <div class="col-md-12 mb-3">
                <a href="<?php echo base_url('lojapromocao/inserir'); ?>" class="btn btn-success margin-button15"><i class="fas fa-plus-circle"></i> Novo</a>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table-sm table-bordered">
                        ...
                        foreach ($lista as $it) : ?>
                            <tr>
                            <td style="width: 40%;"><?php echo $it->nome ?></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-primary" <?php echo 'href="' . base_url('lojapromocao/remover/' . $it->id) . '"' ?> >Sim</a>
