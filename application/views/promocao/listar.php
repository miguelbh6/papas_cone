<div class="container"> 
    ...
    <?php if (sizeof($lista) < 3){ ?>
        <div class="row">
            <div class="col-md-12 mb-3">
                <a href="<?php echo base_url('promocao/inserir'); ?>" class="btn btn-success margin-button15"><i class="fas fa-plus-circle"></i> Novo</a>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table-sm table-bordered">
                        ...
                        foreach ($lista as $it) : ?>
                            ...
                            <td align="center">
                                <img src="<?php echo base_url('upload/img/promocao/'. $it->img) ?>" width="60px" class="img-thumbnail">
                            </div></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-primary" <?php echo 'href="' . base_url('promocao/remover/' . $it->id) . '"' ?> >Sim</a>
